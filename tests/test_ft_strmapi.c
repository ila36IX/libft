...
TestCase strmapi_tests[] = {
	{1, "Convert to uppercase", "omnitrix", to_upper, "OMNITRIX"},
	{2, "Convert to lowercase", "VILGAX", to_lower, "vilgax"},
	...
	{9, "Mixed alphanumeric", "Alien10!", to_upper, "ALIEN10!"},
	{10, "Long string", "It started when an alien device did what it did", to_upper, 
		"IT STARTED WHEN AN ALIEN DEVICE DID WHAT IT DID"},
	{11, "Alphanumeric mix", "Ben10XLR8", alternate_case, "BeN10xLr8"},
	{12, "Add index to chars", "Gwen", all_n, "nnnn"},
	{13, "Add index to longer string", "Kevin", all_n, "nnnnn"},
	{14, "All same char lowercase", "aaaaa", to_upper, "AAAAA"},
	{15, "All same char uppercase", "ZZZZZ", to_lower, "zzzzz"},
	{16, "Mixed case", "HeAt BlAsT", to_upper, "HEAT BLAST"},
	{17, "Mixed case reverse", "DiAmOnDhEaD", to_lower, "diamondhead"},
	{18, "String with newlines", "Four\nArms", identity, "Four\nArms"},
	{19, "String with tabs", "Grey\tMatter", identity, "Grey\tMatter"},
	{21, "NULL input string", NULL, identity, ""},
	{22, "NULL function pointer with valid string", "Upgrade", NULL, "Upgrade"},
	{0, "null", NULL, NULL, ""}
};
